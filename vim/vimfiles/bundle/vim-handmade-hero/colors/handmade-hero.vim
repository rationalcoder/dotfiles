...
let s:todo = ["#c73a3a", 0]
let s:note = ["#6B8E23", 0]
let s:warning = ["#aab830", 0]
let s:important = ["#aab830", 0]
let s:xxx = ["#DDDDDD", 0]
let s:fixme = ["#DD0000", 0]
let s:bug = ["#DD0000", 0]
let s:keyword = ["#CD950C", 0]
let s:function = ["#AC6B51", 0]
...
call s:HL("cCustomFunc", s:function)
call s:HL('Todo', s:keyword, s:back)
call s:HL('cTodo', s:todo, s:back)
call s:HL('cNote', s:note, s:back)
call s:HL('cWarning', s:warning, s:back)
call s:HL('cImportant', s:important, s:back)
call s:HL('cFixme', s:fixme, s:back)
call s:HL('cXxx', s:xxx, s:back)
call s:HL('cBug', s:bug, s:back)
call s:HL('MatchParen', s:at_highlight, s:highlight)
...
call s:HL("SignColumn", s:default, s:back)
